...
_resources = {
    ...
    "endpointslice": {
        ...
        "openapi_path": "io.k8s.api.discovery.v1.EndpointSlice",
        "description": "Endpoint slice",
        "namespaced": True,
    },
    "ingress": {
        "kind": "Ingress",
        "api_version": "networking.k8s.io/v1",
        "openapi_path": "io.k8s.api.networking.v1.Ingress",
        "description": "Ingress",
        "namespaced": True,
    },
    "karpenter_ec2nodeclass": {
        ...
        "openapi_path": "io.k8s.api.karpenter.k8s.aws.v1beta1.EC2NodeClass",
        "description": "Karpenter EC2 NodeClass",
        "namespaced": True,
    },
    "karpenter_nodepool": {
        "kind": "NodePool",
        "api_version": "karpenter.sh/v1beta1",
        "openapi_path": "io.k8s.api.karpenter.v1beta1.NodePool",
        "description": "Karpenter NodePool",
        "namespaced": True,
    },
    "karpenter_nodeclaim": {
        "kind": "NodeClaim",
        "api_version": "karpenter.sh/v1beta1",
        "openapi_path": "io.k8s.api.karpenter.v1beta1.NodeClaim",
        "description": "Karpenter NodeClaim",
        "namespaced": True,
    },
}
